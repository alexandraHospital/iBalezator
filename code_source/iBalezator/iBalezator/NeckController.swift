...
class NeckController {
    ...
    */
    ...
    init ()
    {
        ...
        if(screenWidth == 480) {
            ...
            frettes = [25.0, 166.0, 299.0, 426.0, 544.0, 656.0, 762.0, 862.0, 956.0, 1046.0, 1130.0, 1208.0, 1284.0, 1353.0, 1421.0, 1485.0, 1544.0, 1599.0, 1652.0, 1703.0, 1749.0, 1795.0, 1835.0, 1875.0, 1913.0]
        }
    ...
    */
    ...
    func randomNoteVisible() -> Note
    {
        ...
        var rFrette = Int(arc4random_uniform(UInt32(visible.fretteRight - visible.fretteLeft) + 1) + visible.fretteLeft)
